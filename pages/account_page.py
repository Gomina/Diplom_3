...
class AccountPage(HomePage):
    ...
    def open_user_page(self, create_and_delete_user_with_data):
        # создать пользователя из фикстуры
        ...
        # вставить email
        self.set_text_to_element(TLAP.LOCATOR_FIELD_EMAIL_LOGIN, TU.Email)
        # кликнуть поле "Пароль"
        self.clic_on_element(TLAP.LOCATOR_FIELD_PASSWORD_LOGIN)
        # вставить пароль
        self.set_text_to_element(TLAP.LOCATOR_FIELD_PASSWORD_LOGIN, TU.Password)
